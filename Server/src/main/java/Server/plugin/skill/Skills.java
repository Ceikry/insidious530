...
public final class Skills {
	...
	public void addExperience(int slot, double experience, boolean playerMod) {
		...
		player.getXpTracker().increaseXp(experienceAdd, slot);
	...
	private double getExperienceMod(int slot, double experience, boolean playerMod, boolean multiplyer) {
		...
		// If we have well, we have double xp
		if (WellOfGoodwill.isWellActive()) {
			return experienceMutiplier * 2;
		} else {
			return experienceMutiplier;
		}
	...
	/**
	 * Sets the experienceMutiplier value.
	 * @param experienceMutiplier The experienceMutiplier to set.
	 */
	public void setExperienceMutiplier(double experienceMutiplier) {
		this.experienceMutiplier = experienceMutiplier;
	}

	/**
	 * Gets the experienceMutiplier value.
	 * @return The experienceMutiplier.
	 */
	public double getExperienceMutiplier() {
		return experienceMutiplier;
	}
}