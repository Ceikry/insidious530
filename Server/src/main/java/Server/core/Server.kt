...
import plugin.interaction.inter.custom.osrstab.osrstab.OsrsTab
...
object Server {
    ...
    fun main(args: Array<String>) {
        if (args.isNotEmpty()) {
            ...
            println("Config file supplied! using '"+args[0]+"'")
        } else {
        ...
        OsrsTab.loadClickables("Useful links", "plugin.interaction.inter.osrstab.links", OsrsTab.usefulLinks);
        ...
        // Loads the well of goodwill
        WellOfGoodwill.loadWell();
