...
public final class LoginConfiguration {
    ...
    public static void sendLobbyScreen(Player player) {
        ...
        player.getPacketDispatch().sendString("Want to contribute to Insidious? <br>Visit the github using the link below!", 378, 230);
    ...
    public static final void welcome(final Player player) {
        ...
        if (WellOfGoodwill.isWellActive()) {
            player.getPacketDispatch().sendMessage(WellOfGoodwill.messagesColor+"Well of Goodwill is active, which means the XP is doubled, go train!");
        }
