...
public final class InterfaceManager {
	 ...
	 * The default tabs.
	 */
	public static final int[] DEFAULT_TABS = { 92, 320, /*274*/834, 149, 387, 271, 192, 662, 550, 551, 589, 261, 464, 187, 182 };
...
//				boolean resize = isResizable(); //TODO:
	...
	public void openDefaultTabs() {
		...
		openTab(2, new Component(834)); // Quest 274
	...
	public void closeDefaultTabs() {
		...
		close(new Component(834)); // Quest 274
