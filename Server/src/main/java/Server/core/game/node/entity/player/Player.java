...
import plugin.interaction.inter.custom.teleports.teleports.Teleports;
...
public class Player extends Entity {
	...
	/**
	 * Gets the players previous teleports
	 * @return The previous teleports
	 */
	public List<Teleports> getPreviousTeleports() {
		return previousTeleports;
	}

	/**
	 * The player previous teleports
	 */
	private List<Teleports> previousTeleports = new ArrayList<>();
	 ...
	 */
	private final GamemodeManager gamemodeManager = new GamemodeManager(this);
...
//		return display ? details.getDisplayName() : super.getName();
	...
	public PacketDispatch getPackets() {
		return packetDispatch;
	}
	...
	/**
	 * Gets the gamemodeManager
	 * @return the gamemodeManager
	 */
